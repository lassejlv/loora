  ...
  useEffect(() => {
    ...
    void orpc.history
      ...
      .then((result) => {
        ...
        setPreview({
          id: selectedId,
          document: result.current.document as CanvasDocumentV2,
        })
      })
      .catch(() => {
  ...
  const restore = async (version: Version) => {
    ...
    try {
      ...
      if (version.canvasVersion !== 2) {
        await migrateCanvasVersion(controller.target, version.id, setProgress)
      }
            ...
            <div className="flex min-h-0 flex-col">
                ...
                {selected && selected.canvasVersion !== 2 ? (
                  <div className="grid size-full place-items-center px-8 text-center">
                    <p className="text-xs text-muted-foreground">
                      This checkpoint predates Canvas V2. It is converted once,
                      when you restore it.
                    </p>
                  </div>
              ...
              <div className="shrink-0 space-y-2 p-3">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button
                    disabled={!selected || working || readOnly}
