...
function conflictTitle(
  ...
  main: CanvasDocumentV2 | null,
  draft: CanvasDocumentV2 | null,
) {
...
export function CanvasV2Branches({
  ...
  const mainDocument = (comparison?.mainDocument ?? null) as CanvasDocumentV2 | null
  const draftDocument = (comparison?.draftDocument ?? null) as CanvasDocumentV2 | null
  const baseDocument = (comparison?.baseDocument ?? null) as CanvasDocumentV2 | null
          ...
          {renamingId === branch.id ? (
            ...
            <p className="flex items-center gap-2 text-xs font-medium">
              ...
              {branch.id === activeDraftId ? (
                <span className="shrink-0 rounded bg-secondary px-1 text-[10px] font-normal">
                  Open
                </span>
              ) : null}
              {branch.status !== 'active' ? (
      ...
      <Dialog open={manageOpen} onOpenChange={setManageOpen}>
        <DialogPopup className="max-w-2xl p-0" bottomStickOnMobile={false}>
          ...
          <div className="max-h-[min(64svh,32rem)] min-h-0 overflow-y-auto">
            <ul className="divide-y">
              <li className="flex items-center gap-2 px-3 py-2.5">
                ...
                {activeDraftId ? (
                  ...
                  <span className="rounded bg-secondary px-1 text-[10px]">Open</span>
                )}
              </li>
            ...
            {archived.length > 0 ? (
              <>
                <p className="border-t px-3 pt-3 pb-1 text-[10px] font-medium tracking-wide text-muted-foreground uppercase">
                  Archived
                </p>
                        ...
                        <li key={conflict.id} className="rounded-lg border p-2.5">
                          ...
                          <div className="mt-2 space-y-1">
                            <button
                              ...
                              className={cn(
                                'block w-full rounded-md border px-2 py-1.5 text-left text-[11px]',
