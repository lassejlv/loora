    ...
    <DialogPortal {...portalProps}>
      ...
      >
        <DialogPrimitive.Popup
          className={cn(
            "relative row-start-2 flex max-h-full min-h-0 w-full min-w-0 max-w-lg origin-center flex-col overflow-hidden rounded-xl bg-surface-2 text-popover-foreground opacity-[calc(1-var(--nested-dialogs))] shadow-panel outline-none transition-[scale,opacity,translate] duration-160 ease-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0 sm:scale-[calc(1-0.08*var(--nested-dialogs))] sm:data-ending-style:scale-98 sm:data-starting-style:scale-98",
            bottomStickOnMobile &&
