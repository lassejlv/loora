...
export function Input({
  ...
  const inputClassName = cn(
    "h-8 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(2.5)-1px)] leading-8 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/64 sm:h-7 sm:leading-7",
    size === "sm" &&
