...
import type { CanvasSyncTarget } from '#/lib/canvas-client'
                  ...
                  <>
                    <div className="flex items-center gap-1">
                      <input
                        ...
                        value={url}
                        className="h-8 min-w-0 flex-1 rounded-md border bg-muted px-2 font-mono text-xs outline-none"
