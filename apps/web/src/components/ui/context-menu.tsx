...
const contextMenuItemIconClass =
  ...
  "[&_[data-slot=icon]:not([class*='size-'])]:size-4 sm:[&_[data-slot=icon]:not([class*='size-'])]:size-3.5 [&_svg:not([class*='opacity-'])]:opacity-72 [&_svg:not([class*='size-'])]:size-4 sm:[&_svg:not([class*='size-'])]:size-3.5 [&_svg]:pointer-events-none [&_svg]:shrink-0";
