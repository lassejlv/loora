...
Billing is Polar plan access plus capacity limits (enforced): Free is 50 design
files, 1 open branch per design, 1 GB asset storage, and 2 days of version
history; Pro is unlimited files and branches with 100 GB asset storage and
90 days of version history. MCP tool calls are metered weekly (no prepaid AI
credits or top-ups).
