...
TODO(confirm): exact primary hosting and subprocessors’ processing regions for Railway, S3-compatible asset storage, Neon AI Gateway, Databuddy, Polar, and Google/GitHub/OpenAI, and the transfer safeguards relied on (for example EU Standard Contractual Clauses or adequacy decisions).
